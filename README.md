...
* master: Pandar ROS driver for Ubuntu 18.04 supports the latest UDP protocol v1.4
* UDP1.4_ubuntu16.04: Pandar ROS driver for Ubuntu 16.04 supports the latest UDP protocol v1.4
* UDP1.3: Pandar ROS driver for ubuntu16.04 and ubuntu 18.04 supports UDP protocol v1.3    
